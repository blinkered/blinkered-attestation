# Provenance: Latviešu (lv)

Generated by `pnpm dictionary build --language=lv`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 17087 words, counted toward the board's word floor |
| full tier | 99801 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 for the common tier; no limit for credit |
| validation yield | 85.4% at the common cut, 70.0% at the full cut |
| corpus coverage | 92.1% of all occurrences |
| board density | median 58 words on 12 tiles, 92.3% hold a six-letter word |

## Sources

**Ordering.** hermitdave/FrequencyWords, from the OpenSubtitles 2018 corpus via OPUS, MIT.
`https://raw.githubusercontent.com/hermitdave/FrequencyWords/master/content/2018/lv/lv_full.txt`
...
Group 1:
- hunspell `lv` (LGPL-2.1-or-later) — Latvian spelling dictionary, Jānis Eisaks and the LibreOffice Latvian project
