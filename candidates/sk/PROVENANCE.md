# Provenance: Slovenčina (sk)

Generated by `pnpm dictionary build --language=sk`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 17538 words, counted toward the board's word floor |
| full tier | 287672 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 for the common tier; no limit for credit |
| validation yield | 87.7% at the common cut, 43.2% at the full cut |
| corpus coverage | 92.5% of all occurrences |
| board density | median 44 words on 12 tiles, 78.0% hold a six-letter word |
...
Group 1:
- hunspell `sk` (LGPL-2.1-or-later) — Slovak spelling dictionary, Zdenko Podobný and the sk-spell project
