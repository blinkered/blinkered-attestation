# Provenance: Afrikaans (af)

Generated by `pnpm dictionary build --language=af`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 12354 words, counted toward the board's word floor |
| full tier | 12354 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 for the common tier; no limit for credit |
| validation yield | 71.8% at the common cut, 71.8% at the full cut |
| corpus coverage | 93.9% of all occurrences |
| board density | median 107 words on 12 tiles, 97.3% hold a six-letter word |

## Sources

**Ordering.** hermitdave/FrequencyWords, from the OpenSubtitles 2018 corpus via OPUS, MIT.
`https://raw.githubusercontent.com/hermitdave/FrequencyWords/master/content/2018/af/af_full.txt`
...
Group 1:
- hunspell `af_ZA` (LGPL-2.1-or-later) — MySpell Afrikaans, Translate.org.za; word lists by Bernard A Nieuwoudt and Danie Viljoen, affix file by Dwayne Bailey, all relicensed under the LGPL
