# Provenance: Română (ro)

Generated by `pnpm dictionary build --language=ro`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 16326 words, counted toward the board's word floor |
| full tier | 187238 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 for the common tier; no limit for credit |
| validation yield | 81.6% at the common cut, 23.7% at the full cut |
| corpus coverage | 91.7% of all occurrences |
| board density | median 118 words on 12 tiles, 97.0% hold a six-letter word |
...
Group 1:
- hunspell `ro` (LGPL-2.1-or-later) — Romanian hunspell package, the Rospell team
