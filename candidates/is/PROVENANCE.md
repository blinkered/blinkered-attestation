# Provenance: Íslenska (is)

Generated by `pnpm dictionary build --language=is`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 14261 words, counted toward the board's word floor |
| full tier | 68689 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 for the common tier; no limit for credit |
| validation yield | 71.3% at the common cut, 37.8% at the full cut |
| corpus coverage | 80.4% of all occurrences |
| board density | median 88 words on 12 tiles, 95.3% hold a six-letter word |

## Sources

**Ordering.** hermitdave/FrequencyWords, from the OpenSubtitles 2018 corpus via OPUS, MIT.
`https://raw.githubusercontent.com/hermitdave/FrequencyWords/master/content/2018/is/is_full.txt`
...
Group 1:
- hunspell `is` (CC-BY-SA-3.0) — Icelandic spelling dictionary, Stofnun Árna Magnússonar í íslenskum fræðum
...
relied on, and it is never GPL. Distributed under `CC-BY-SA-3.0`.
