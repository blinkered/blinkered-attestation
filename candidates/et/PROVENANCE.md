...
Generated by `pnpm dictionary build --language=et`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 17552 words, counted toward the board's word floor |
| full tier | 589422 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 for the common tier; no limit for credit |
| validation yield | 87.8% at the common cut, 67.3% at the full cut |
| corpus coverage | 94.4% of all occurrences |
| board density | median 119 words on 12 tiles, 98.0% hold a six-letter word |

## Sources

**Ordering.** hermitdave/FrequencyWords, from the OpenSubtitles 2018 corpus via OPUS, MIT.
`https://raw.githubusercontent.com/hermitdave/FrequencyWords/master/content/2018/et/et_full.txt`
...
Group 1:
- hunspell `et` (LGPL-2.1-or-later) — Estonian spelling dictionary, the Institute of the Estonian Language
