# Provenance: Türkçe (tr)

Generated by `pnpm dictionary build --language=tr`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 17867 words, counted toward the board's word floor |
| full tier | 638282 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 for the common tier; no limit for credit |
| validation yield | 89.3% at the common cut, 37.8% at the full cut |
| corpus coverage | 93.1% of all occurrences |
| board density | median 79 words on 12 tiles, 91.3% hold a six-letter word |
...
Group 1:
- hunspell `tr` (MIT) — Turkish spelling dictionary, Harun Reşit Zafer
