# Provenance: Polski (pl)

Generated by `pnpm dictionary build --language=pl`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 18297 words, counted toward the board's word floor |
| full tier | 544157 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 for the common tier; no limit for credit |
| validation yield | 91.5% at the common cut, 43.3% at the full cut |
| corpus coverage | 94.8% of all occurrences |
| board density | median 53 words on 12 tiles, 88.0% hold a six-letter word |
...
Group 1:
- hunspell `pl` (MPL-2.0) — Polish spelling dictionary, Marek Futrega and the sjp.pl contributors
