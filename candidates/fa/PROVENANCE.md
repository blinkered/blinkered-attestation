...
Generated by `pnpm dictionary build --language=fa`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 13248 words, counted toward the board's word floor |
| full tier | 51132 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 for the common tier; no limit for credit |
| validation yield | 66.2% at the common cut, 18.2% at the full cut |
| corpus coverage | 79.0% of all occurrences |
| board density | median 249 words on 12 tiles, 97.3% hold a six-letter word |

## Sources

**Ordering.** hermitdave/FrequencyWords, from the OpenSubtitles 2018 corpus via OPUS, MIT.
`https://raw.githubusercontent.com/hermitdave/FrequencyWords/master/content/2018/fa/fa_full.txt`
...
Group 1:
- hunspell `fa` (Apache-2.0) — Lilak, Persian spell checking dictionary, Reza Sarabi
...
relied on, and it is never GPL. Distributed under `Apache-2.0`.
