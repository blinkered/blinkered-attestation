# Provenance: Български (bg)

Generated by `pnpm dictionary build --language=bg`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 17555 words, counted toward the board's word floor |
| full tier | 279165 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 for the common tier; no limit for credit |
| validation yield | 87.8% at the common cut, 32.4% at the full cut |
| corpus coverage | 93.3% of all occurrences |
| board density | median 78 words on 12 tiles, 96.3% hold a six-letter word |

## Sources

**Ordering.** hermitdave/FrequencyWords, from the OpenSubtitles 2018 corpus via OPUS, MIT.
`https://raw.githubusercontent.com/hermitdave/FrequencyWords/master/content/2018/bg/bg_full.txt`
...
Group 1:
- hunspell `bg` (LGPL-2.1-or-later) — Bulgarian spelling dictionary, the bgOffice project
