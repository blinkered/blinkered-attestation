# Provenance: Magyar (hu)

Generated by `pnpm dictionary build --language=hu`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 17943 words, counted toward the board's word floor |
| full tier | 1295061 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 for the common tier; no limit for credit |
| validation yield | 89.7% at the common cut, 61.6% at the full cut |
| corpus coverage | 92.9% of all occurrences |
| board density | median 54 words on 12 tiles, 92.0% hold a six-letter word |

## Sources

**Ordering.** hermitdave/FrequencyWords, from the OpenSubtitles 2018 corpus via OPUS, MIT.
`https://raw.githubusercontent.com/hermitdave/FrequencyWords/master/content/2018/hu/hu_full.txt`
...
Group 1:
- hunspell `hu` (LGPL-2.1-or-later) — Szabad magyar szótár (Magyar Ispell), László Németh and contributors
